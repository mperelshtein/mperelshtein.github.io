...
const WaitlistRu = () => {
  ...
  return <section id="waitlist" className="bg-[#ffffff] py-[40px]">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-[#ffffff] rounded-3xl p-8 border shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button onClick={handleFeedback} className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 h-12 rounded-xl">Форма обратной связи</Button>
            </div>
